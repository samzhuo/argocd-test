...
{{- $optional := default "redis redis-sentinel objectstorage postgres ldap duo omniauth smtp kas pages oauth-secrets mailroom gitlab-exporter microsoft_graph_mailer amazon_ses_mailer zoekt clickhouse openbao knowledge_graph iam-auth iam-data-access" $.optional | splitList " " -}}
